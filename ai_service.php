...
class AIService {
    ...
    private function callOpenAI($prompt) {
        ...
        $data = [
            ...
            'messages' => [
                [
                    'role' => 'system',
                    'content' => 'あなたは分析したサイト内容に基づいて最適化されたコラム記事を作成する専門家です。サイトの特徴、ターゲット読者、コンテンツの傾向を理解し、SEOを意識した読みやすく魅力的な記事を作成してください。'
                ],
                [
                    'role' => 'user',
                    'content' => $cleanPrompt
    ...
    private function callClaude($prompt) {
        ...
        $data = [
            ...
            'max_tokens' => 16000,
            'temperature' => 0.7,
            'system' => 'あなたは分析したサイト内容に基づいて最適化されたコラム記事を作成する専門家です。サイトの特徴、ターゲット読者、コンテンツの傾向を理解し、SEOを意識した読みやすく魅力的な記事を作成してください。',
            'messages' => [
                [
                    'role' => 'user',
                    'content' => $prompt
        ...
        $data = [
            'contents' => [
                [
                    ...
                    'parts' => [
                        [
                            'text' => 'あなたは分析したサイト内容に基づいて最適化されたコラム記事を作成する専門家です。サイトの特徴、ターゲット読者、コンテンツの傾向を理解し、SEOを意識した読みやすく魅力的な記事を作成してください。\n\n' . $cleanPrompt
                        ]
                    ]
                ]
            ],
