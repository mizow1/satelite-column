...
class PromptGenerator {
    ...
    private function getArticleRequirements() {
        return "記事の要件：\n" .
               "- 必ず10,000文字以上の詳細な記事を作成する（これは最重要要件です）\n" .
               "- 完全なマークダウン形式で出力する\n" .
               "- 占い好きな人が興味を持つ内容\n" .
               "- SEOを意識したキーワードの自然な配置\n" .
               "- 読みやすい構成（見出し、段落分け）\n" .
    ...
    private function getArticleStructure() {
        return "記事構成の指針：\n" .
               "1. 導入部（800-1000文字）：読者の関心を引く導入\n" .
               "2. 基礎知識（1500-2000文字）：テーマの基本的な説明\n" .
               "3. 詳細解説（2000-3000文字）：具体的な内容の深掘り\n" .
               "4. 実践的な応用（2000-2500文字）：読者が実践できる方法\n" .
               "5. 事例・体験談（1500-2000文字）：具体的な例や体験談\n" .
               "6. まとめ・次のステップ（1000-1500文字）：総括と今後の展望\n\n";
    }
    ...
    private function getImportantNotes() {
        return "重要な注意事項：\n" .
               ...
               "- 文字数カウントを行い、10,000文字以上を確実に達成する\n" .
               "- 各セクションは必ず指定された文字数を満たす内容で執筆する\n";
    }
